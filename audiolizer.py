...
if __name__ == '__main__':
	...
	freqs = [25.572 * math.exp(0.0966*x) for x in range(N)]
	...
	freq_max_amplitude = np.iinfo(np.int16).max // N
	...
	with warnings.catch_warnings():
		...
		WAV.writeframes((audio_frames * freq_max_amplitude).astype(np.int16).tobytes())
		WAV.close()
		# out_video.release()
		# input()